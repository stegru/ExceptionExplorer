namespace ExceptionExplorer.UI
{
    ...
    /// </summary>
    public class CallStackList : ExtendedListView, IExceptionExplorerControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallStackList"/> class.
        /// </summary>
        public CallStackList()
            : base()
        {
        ...
        protected override void OnItemSelectionChanged(ListViewItemSelectionChangedEventArgs e)
        {
            ...
            if ((info != null) && (this.MethodSelected != null) && e.IsSelected)
            {
                ...
                this.LastMethodSelected = new MethodEventArgs(method, caller, me.Exception);
                this.MethodSelected(this, this.LastMethodSelected);
            }

            base.OnItemSelectionChanged(e);
        }

        public MethodEventArgs LastMethodSelected { get; private set; }

        internal CallStack GetCallStackForChild(ItemInfo info)
        {
        ...
        internal static NodeInfo CreateNodeInfo(ListViewItem item)
        {
            ...
            IAnalysisObject analysisObject = null;
            if (info.Data is MethodItem)
            {
                MethodItem mi = (MethodItem)info.Data;
                if ((mi.Exception != null) && (mi.CalledBy == null))
                {
                    analysisObject = Class.GetClass(mi.Exception.Exception);
                }
                else
                {
                    analysisObject = mi.Method;
                }
            }
            else
            {
                analysisObject = info.Data as IAnalysisObject;
            }
            ...
            return new NodeInfo(info.Item.Text, analysisObject, NodeInfo.TypeFromObject(analysisObject))
            {
                ExtraData = info
            };
        }
