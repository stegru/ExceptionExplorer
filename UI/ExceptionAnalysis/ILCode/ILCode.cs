namespace ExceptionExplorer.IL
{
    ...
    internal class ILCode : IDisposable
    {
        ...
        private const int MultibyteValue = 0xFE;
        ...
        /// <summary>Gets, and caches, the generic arguments for the method.</summary>
        /// <returns>An array of the method's generic arguments.</returns>
        ...
        /// <summary>Gets, and caches, the generic arguments for the type.</summary>
        /// <returns>An array of the type's generic arguments.</returns>
