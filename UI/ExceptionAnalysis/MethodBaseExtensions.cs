namespace ExceptionExplorer.ExceptionAnalysis
{
    ...
    public static class MethodBaseExtensions
    {
        ...
        public static string GetSignature(this MethodBase method, bool includeClass)
        {
            ...
            foreach (ParameterInfo pi in method.GetParameters())
            {
                ...
                else
                {
                    ...
                    if (rootType.IsPrimitive || rootType == typeof(void) || rootType == typeof(TypedReference))
                    {
                        typeName = typeName.Substring(7); // "System.".Length
                    }
                    sig.Append(typeName);
                }
        ...
        public static IEnumerable<MethodBase> GetAllMethods(this Type type)
        {
            ...
            return type.GetConstructors(Binding).Cast<MethodBase>().Concat(type.GetMethods(Binding));
        }
    }
}